...
import com.fudgeProductName.kik.comment_stuff.CommentItem;
   ...
   // ProgressBar progressBar;
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            final String STREAMURL = "http://mobile.coachparrot.com/comment/get_course_comments/1";//activity.getResources().getString(R.string.default_comments_url);
